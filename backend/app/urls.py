...
urlpatterns = [
    ...
    path('api/v1/user-hackathons-hosted/<int:user_id>/', views.UserHackathonsAPIView.as_view(), name='user-hackathons'),
    path('api/v1/user-hackathons-participated/<int:user_id>/', views.UserParticipatedHackathonAPIView.as_view(), name='user-hackathons-participated'),
